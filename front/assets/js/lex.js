...
home.addEventListener("click", function (e) {
  ...
  frame.src =
    "https://heyazah.viewin360.co/share/5Dh5S?logo=-1&info=0&fs=0&vr=1&gyro=0&thumbs=-1&inst=0&keys=0";
});
...
wave.addEventListener("click", function (e) {
  e.preventDefault();
  console.log("wdem");
  location.pathname = location.pathname.replace("lex", "sigma");
});

lex.addEventListener("click", function (e) {
  e.preventDefault();
  console.log("wdem1");
  location.pathname = location.pathname.replace("lex", "lex");
});

skyline.addEventListener("click", function (e) {
  e.preventDefault();
  console.log("wdem2");
  location.pathname = location.pathname.replace("lex", "sky-line");
});

heyazah.addEventListener("click", function (e) {
  e.preventDefault();
  console.log("wdem3");
  location.pathname = location.pathname.replace("lex", "heyazah-gate");
});

businessYard.addEventListener("click", function (e) {
  e.preventDefault();
  console.log("wdem4");
  location.pathname = location.pathname.replace("lex", "business-yard");
});
