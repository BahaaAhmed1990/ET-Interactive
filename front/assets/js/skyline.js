...
home.addEventListener("click", function (e) {
  ...
  frame.src =
    "https://heyazah.viewin360.co/share/5DpPL?logo=-1&info=0&fs=0&vr=1&gyro=0&thumbs=-1&inst=0&keys=0";
});
...
landscape.addEventListener("click", function (e) {
  ...
  gallerySubMenu.classList.remove("active");
  frame.src =
    "https://heyazah.viewin360.co/share/5DpP7?logo=-1&info=0&fs=0&vr=1&gyro=0&thumbs=-1&inst=0&keys=0";
});
...
surroundings.addEventListener("click", function (e) {
  ...
  gallerySubMenu.classList.remove("active");
  frame.src =
    "https://heyazah.viewin360.co/share/5DpPh?logo=-1&info=0&fs=0&vr=1&gyro=0&thumbs=-1&inst=0&keys=0";
});
...
lex.addEventListener("click", function (e) {
  e.preventDefault();
  console.log("wdem1");
  location.pathname = location.pathname.replace("sky-line", "lex");
});

skyline.addEventListener("click", function (e) {
  e.preventDefault();
  console.log("wdem2");
  location.pathname = location.pathname.replace("sky-line", "sky-line");
});
